...
// Aston Martin Racing brand colors
const vec3 TIFFANY_GREEN = vec3(0.0118, 0.4784, 0.4078); // #037A68
const vec3 ASTON_GRAY = vec3(0.4, 0.4039, 0.4118); // #666769
const vec3 WHITE = vec3(1.0);

vec3 mainColor = TIFFANY_GREEN;
