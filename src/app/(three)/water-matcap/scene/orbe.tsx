...
export function Orbe({
  ...
  const debugOrbe = false
  const renderOrbe = true
  ...
  useFrame(() => {
    ...
    materials.raymarchMaterial.uniforms.uPyramidMatrix.value
  ...
  return (
    <>
      ...
      <mesh visible={renderOrbe} position={ORBE_WATER_CENTER as any}>
        ...
        <primitive object={materials.raymarchMaterial} />
      </mesh>
...
function OrbeSphere({
  ...
  useFrame((state, delta) => {
    ...
    materials.raymarchMaterial.uniforms.uSphereMix.value = clamp(
      0,
      1,
    ...
    materials.raymarchMaterial.uniforms.uSphereMatrix.value
