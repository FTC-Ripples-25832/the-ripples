...
const tiffany = new THREE.Color("#037A68")
const astonGray = new THREE.Color("#666769")
...
function Room() {
  return (
    <group position={[0, -0.5, 0]}>
      ...
      >
        <meshStandardMaterial color={astonGray} side={THREE.BackSide} />
      </mesh>
      {/** Some boxes */}
      <mesh
        geometry={box}
      ...
      >
        <meshStandardMaterial color={tiffany} />
      </mesh>
      <mesh
        geometry={box}
