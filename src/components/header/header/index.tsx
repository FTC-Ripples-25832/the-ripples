    ...
    <>
      <div className="sticky w-full top-0 p-0 bg-black/70 z-over-canvas">
        <header className="h-[3rem] px-6 flex items-center justify-between z-40 relative border-b border-[var(--color-gray-lighter)]">
          <div className="flex basis-[30%] flex-grow items-center gap-8">
            ...
            <ul className="flex flex-row font-mono gap-x-4 text-sm items-center">
              <li>
                <Link
                  href="/team"
                  className={`hover:underline hover:opacity-75 transition`}
                >
                  <span>TEAM</span>
                </Link>
              </li>
          ...
          <div className="flex items-center gap-4">
            <Link
              href="/timeline"
              className="font-mono text-tiffany-300 hover:underline hover:opacity-75 transition"
            >
              <span className="font-bold">NEWS</span>
              <span className="hidden md:inline">: Off to Worlds!</span>
            </Link>
            <GithubLink />
